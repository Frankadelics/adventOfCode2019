...
//	bool operator< (const PointAndIntersection& rhs) const
//	{
//		return horizontalSeg.rank < rhs.horizontalSeg.rank;
//	}
//};
//
...
//	return answer;
//}
//int getSmallestPathV2(vector <PointAndIntersection>& pai, vector<Segment>& red, vector<Segment> black)
//{
//	int totalBlackSeg = 0;
//	int totalRedSeg = 0;
//	int rank = 0;
...
//		if (pai[i].horizontalSeg.wireColor == 'B')
//		{
//			//cout << "------------------" << i << " Run Through--------------------------" << endl;
//			//cout << "Color: " << pai[i].horizontalSeg.wireColor << endl;
//			rank = pai[i].horizontalSeg.rank;
//			//cout << "Rank: " << pai[i].horizontalSeg.rank << endl;
//			for (int j = 0; j < rank; j++)
//			{
//				totalBlackSeg += black[j].length;
//				extraDistanceToSubtract = abs(black[j].end.x);
//			//	cout << "totalBlackSegFor: " << totalBlackSeg << endl;
//			}
//			//cout << "horizontalSeg length: " << pai[i].horizontalSeg.length << endl;
//			number = abs(abs(pai[i].intersection.x) - abs(pai[i].horizontalSeg.start.x));
//			totalBlackSeg += number;
//			//cout << "TotalBlackSeg: " << totalBlackSeg << endl;
//			//cout << "Number: " << number << endl << endl;;
//			//cout << "------------------" << endl;
//
//			//cout << "Color: " << pai[i].verticalSeg.wireColor << endl;
//			rank = pai[i].verticalSeg.rank;
//			//cout << "Rank: " << rank << endl;
//			for (int f = 0; f < rank; f++)
//			{
//				totalRedSeg += red[f].length;
//			//	cout << "totalRedSegFor: " << totalRedSeg << endl;
//			}
//			//cout << "verticalSeg length: " << pai[i].verticalSeg.length << endl;
//			number = abs(abs(pai[i].intersection.y) - abs(pai[i].verticalSeg.start.y));
//			totalRedSeg += number;
//			//cout << "TotalRedSeg: " << totalRedSeg << endl;
//			//cout << "Number: " << number << endl;
//			totalSeg = totalBlackSeg + totalRedSeg;
//			//cout << "totalSegB: " << totalSeg << endl;
//			//cout << "-------------------------------------------------------------------" << endl;
//
//			
//		}
...
//			//cout << "-------------------------------------------------------------------" << endl;
//
//			totalSeg = totalRedSeg + totalBlackSeg;
//			//cout << "totalSegR: " << totalSeg << endl;
//		}
//		if (i == 0) { compare = totalSeg; }
//		if (compare > totalSeg) { compare = totalSeg; cout << "i: " << i << endl; }
//
//	}
//	return compare;
//}
...
//{
//	for (int i = 0; i < pai.size(); i++)
//		cout << i << ". Point: (" << pai[i].intersection.x << ", " << pai[i].intersection.y << ")" <<
//		" hRank: " << pai[i].horizontalSeg.wireColor << pai[i].horizontalSeg.rank << " vRank: " <<
//		pai[i].verticalSeg.wireColor << pai[i].verticalSeg.rank << " hStart: (" << pai[i].horizontalSeg.start.x <<
//		", " << pai[i].horizontalSeg.start.y << ") hEnd: (" << pai[i].horizontalSeg.end.x <<
//		", " << pai[i].horizontalSeg.end.y << ") hLength: " << pai[i].horizontalSeg.length <<
//		" vLength: " << pai[i].verticalSeg.length << " vStart: (" << pai[i].verticalSeg.start.x <<
//		", " << pai[i].verticalSeg.start.y << ") vEnd: (" << pai[i].verticalSeg.end.x << ", " << pai[i].verticalSeg.end.y << ")" << endl;
//}
//
//int main()
//{
...
//
//	cout << "Answer: " << getSmallestPathV2(pai, redSegments, blackSegments) << endl;
//	//cout << "-----------------------------------------PAI-------------------------------------------------" << endl;
//	//printPAI(pai);
